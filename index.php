...
<body>
    ...
    <main>
        <div id="container">
          <div class="texto">
            <h1>Sistema de Captura de Cursos UNAM</h1>
            <p>Bienvenido al Sistema de Captura de Cursos UNAM, puedes seleccionar estudiante o profesor para ingresar al sistema con tu respectiva cuenta</p>
          </div><!--Fin texto-->
          
          <div class="acceso" style="display: flex; justify-content: center;">
            <div class="card" style="width: 18rem;">
              <h2 class="card-title">Inicio de sesión</h2>
              <h6 class="card-subtitle mb-2 text-body-secondary">Ingresar a pagina de inicio de sesion alumno</h6>
